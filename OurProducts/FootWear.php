...
<body>
	...
	<div class="categolis">
		<table>
			<tr>
                ...
                <th><a href="Watches.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">Watches</a></th>
	...
	<div style="padding: 30px 120px; font-size: 25px; margin: 0 auto; display: table; width: 98%;">
		<div>
		<?php 
			$getposts = mysqli_query($ccon,"SELECT * FROM products WHERE available >='1' AND item ='footwear'  ORDER BY id DESC LIMIT 10") or die(mysqli_error());
