...
<body>
	...
	<div style="padding: 15px 0px; font-size: 15px; margin: 0 auto; display: table; width: 98%;">
		<div>
		<?php 
			$getposts = mysqli_query($ccon,"SELECT * FROM products WHERE available >='1' AND item ='watch'  ORDER BY id DESC LIMIT 10") or die(mysqli_error());
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<div class="home-prodlist-img"><a href="view_product.php?pid='.$id.'">
										<img src="../image/product/watches/'.$picture.'" class="home-prodlist-imgi">
										</a>
